...
\input{canzoni/Sis_Triumphans_O_Schola_Normalis}
\input{canzoni/Priore_Ciao}
\input{canzoni/LArno_Mormorava}
\input{canzoni/Santannin}
\input{canzoni/Il_vero_Normalista}
\clearpage
\logofalse
\newgeometry{top=0mm,bottom=0mm,left=0mm,right=0mm}
